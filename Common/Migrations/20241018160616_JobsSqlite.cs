    ...
    public partial class JobsSqlite : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SCHED_NAME = table.Column<string>(type: "text", nullable: false, collation: "NOCASE"),
                    CALENDAR_NAME = table.Column<string>(type: "text", nullable: false, collation: "NOCASE"),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    SCHED_NAME = table.Column<string>(type: "text", nullable: false, collation: "NOCASE"),
                    ENTRY_ID = table.Column<string>(type: "text", nullable: false, collation: "NOCASE"),
                    TRIGGER_NAME = table.Column<string>(type: "text", nullable: false, collation: "NOCASE"),
                    TRIGGER_GROUP = table.Column<string>(type: "text", nullable: false, collation: "NOCASE"),
                    INSTANCE_NAME = table.Column<string>(type: "text", nullable: false, collation: "NOCASE"),
                    FIRED_TIME = table.Column<long>(type: "bigint", nullable: false),
                    SCHED_TIME = table.Column<long>(type: "bigint", nullable: false),
                    PRIORITY = table.Column<int>(type: "integer", nullable: false),
                    STATE = table.Column<string>(type: "text", nullable: false, collation: "NOCASE"),
                    JOB_NAME = table.Column<string>(type: "text", nullable: true, collation: "NOCASE"),
                    JOB_GROUP = table.Column<string>(type: "text", nullable: true, collation: "NOCASE"),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    SCHED_NAME = table.Column<string>(type: "text", nullable: false, collation: "NOCASE"),
                    JOB_NAME = table.Column<string>(type: "text", nullable: false, collation: "NOCASE"),
                    JOB_GROUP = table.Column<string>(type: "text", nullable: false, collation: "NOCASE"),
                    DESCRIPTION = table.Column<string>(type: "text", nullable: true, collation: "NOCASE"),
                    JOB_CLASS_NAME = table.Column<string>(type: "text", nullable: false, collation: "NOCASE"),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    SCHED_NAME = table.Column<string>(type: "text", nullable: false, collation: "NOCASE"),
                    LOCK_NAME = table.Column<string>(type: "text", nullable: false, collation: "NOCASE")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TRIGGER_STATE = table.Column<string>(type: "text", nullable: false, collation: "NOCASE"),
                    TRIGGER_TYPE = table.Column<string>(type: "text", nullable: false, collation: "NOCASE"),
                    START_TIME = table.Column<long>(type: "bigint", nullable: false),
                    END_TIME = table.Column<long>(type: "bigint", nullable: true),
                    CALENDAR_NAME = table.Column<string>(type: "text", nullable: true, collation: "NOCASE"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TRIGGER_NAME = table.Column<string>(type: "text", nullable: false, collation: "NOCASE"),
                    TRIGGER_GROUP = table.Column<string>(type: "text", nullable: false, collation: "NOCASE"),
                    CRON_EXPRESSION = table.Column<string>(type: "text", nullable: false, collation: "NOCASE"),
                    TIME_ZONE_ID = table.Column<string>(type: "text", nullable: true, collation: "NOCASE")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TRIGGER_NAME = table.Column<string>(type: "text", nullable: false, collation: "NOCASE"),
                    TRIGGER_GROUP = table.Column<string>(type: "text", nullable: false, collation: "NOCASE"),
                    STR_PROP_1 = table.Column<string>(type: "text", nullable: true, collation: "NOCASE"),
                    STR_PROP_2 = table.Column<string>(type: "text", nullable: true, collation: "NOCASE"),
                    STR_PROP_3 = table.Column<string>(type: "text", nullable: true, collation: "NOCASE"),
