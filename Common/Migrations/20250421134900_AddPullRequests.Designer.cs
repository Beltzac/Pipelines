...
namespace Common.Migrations
{
    ...
    [Migration("20250421134900_AddPullRequests")]
            ...
            modelBuilder.Entity("Repository", b =>
                {
                    ...
                    b.OwnsMany("PullRequest", "ActivePullRequests", b1 =>
                        {
                            b1.Property<int>("Id")
                                .HasColumnType("INTEGER");

                            b1.Property<int>("ChangedFileCount")
                                .HasColumnType("INTEGER");

                            b1.Property<Guid>("RepositoryId")
                                .HasColumnType("TEXT");

                            b1.Property<string>("SourceBranch")
                                .IsRequired()
                                .HasMaxLength(100)
                                .HasColumnType("TEXT")
                                .UseCollation("NOCASE");
                            ...
                            b1.ToTable("RepositoryPullRequests", (string)null);
